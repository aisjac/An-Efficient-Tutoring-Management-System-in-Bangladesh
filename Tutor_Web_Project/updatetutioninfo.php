...
if (isset($_REQUEST['uid'])) {
	...
	$unicpic_db = $get_tutor_name['nidpic'];
...
if (isset($_POST['updatetutioninfo'])) {
	...
	try {
				if(($user == $_REQUEST['uid']) && ($utype_db == "teacher"))
				{
					...
					if($result4 = mysqli_query($con, "INSERT INTO tutor (t_id,prefer_sub,class,medium,inst_name,salary,prefer_location) VALUES ('$user','$sublist','$classlist','$mediumlist','$uinst_db','$_POST[sal_range]','$_POST[location]')")){
