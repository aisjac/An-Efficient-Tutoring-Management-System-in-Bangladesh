				...
				if ($email_check == 0) {
					if (strlen($_POST['password']) >1 ) {
						...
						if (@mail($_POST['email'],"eBuyBD Activation Code",$msg, "From:eBuyBD <no-reply@ebuybd.xyz>")) {
							...
							$result = mysqli_query($con, "INSERT INTO user (fullname,gender,email,phone,pass,type,confirmcode) VALUES ('$_POST[first_name]','$_POST[gender]','$_POST[email]','$_POST[mobile]','$_POST[password]','$_POST[account]','$confirmCode')");
...
$_POST['first_name'] = $u_fname;
$_POST['email'] = $u_email;
$_POST['mobile'] = $u_mobile;
...
<div>
		<header class="header">
			...
			<div class="header-cont">
				...
				<h3><a href="#">Hotline:01729307612</a></h3>
